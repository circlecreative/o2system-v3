...
class O2_DB_oci8_driver extends O2_DB {
	...
	var $_commit = OO2_COMMIT_ON_SUCCESS;
	...
	public function stored_procedure($package, $procedure, $params)
	{
		...
		foreach ($params as $param)
		{
			...
			if (array_key_exists('type', $param) && ($param['type'] === OO2_B_CURSOR))
			{
				$have_cursor = TRUE;
			}
		}
	...
	public function trans_commit()
	{
		...
		$this->_commit = OO2_COMMIT_ON_SUCCESS;
		return $ret;
	}
