	...
	<head>
		...
		<style type="text/css">
			...
			* { margin:  0px; padding: 0px; }
			...
			.panel-messages { background-color: #fff; color: #333; text-align: left; width: 100%; height: auto; padding: 45px 40px 25px 40px; }
			...
			<div class="row">
				<div class="panel-box">
					<div class="panel-header">
						...
						<img src="<?php echo system_url(); ?>application/assets/images/logo-50.png" alt="">
					</div>
