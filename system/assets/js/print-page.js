    ...
    var components = {
      ...
      messageBox: function(message){
        return "<div id='printMessageBox' style='\
          ...
          width:310px; height:120px; font-size:14px; padding:10px; color:#222;\
          opacity:0;\
          ...
          box-shadow:0px 0px 10px #ebebeb; -webkit-box-shadow:0px 0px 10px #ebebeb; -moz-box-shadow:0px 0px 10px #ebebeb'>\
          "+message+"</div>";
      }
    };
  };
