			...
			if (settings.vertical)
			{
				...
				refreshV = function()
				{
					...
					vscrollbar.stop(true)[(settings.animate && init) ? 'animate' : 'css']({
						...
						left: (element.innerWidth()-(settings.usePadding ? element.parseCSSValue('padding-right')+settings.padding.right : settings.padding.right)-settings.width+scrollH)+10+'px',
