...
class Core_Cart {
	...
	public function __construct($params = array())
	{
		...
		$this->O2->load->library('session', $config);

		// Grab the shopping cart array from the session table, if it exists
		if ($this->O2->session->userdata('cart_contents') !== FALSE)
		{
			$this->_cart_contents = $this->O2->session->userdata('cart_contents');
		}
		else
		{
	...
	function _save_cart()
	{
		...
		{
			$this->O2->session->unset_userdata('cart_contents');
		...
		$this->O2->session->set_userdata(array('cart_contents' => $this->_cart_contents));
