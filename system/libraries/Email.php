...
class Core_Email {
	...
	protected function _prep_q_encoding($str, $from = FALSE)
	{
		...
		for ($i = 0, $length = strlen($str); $i < $length; $i++)
		{
			...
			// convert ALL non-printable ASO2I characters and our specials
	...
	protected function _set_error_message($msg, $val = '')
	{
		...
		if (substr($msg, 0, 5) != 'lang:' || FALSE === ($line = $O2->lang->line(substr($msg, 5))))
		{
