...
<head>
    ...
    <style type="text/css">
        ...
        * { margin:  0px; padding: 0px; }
        ...
        .panel-messages { background-color: #fff; color: #333; text-align: center; width: 100%; height: auto; padding: 65px 40px 25px 40px; }
        .panel-messages p { color: #333; font-size: 20px; }
