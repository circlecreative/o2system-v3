	...
	<div class="col-md-12">
		<div class="tabs-vertical-env">
			<ul class="nav tabs-vertical">
				...
				<?php if($key == 0) $active = 'content-'.alias($selector); ?>
		        <li <?php echo ($key == 0 ? 'class="active"' : ''); ?>>
		        	<a href="#content-<?php echo alias($selector); ?>" data-toggle="tab"><?php echo $selector; ?></a>
		        </li>
		    	<?php endforeach; ?>
		    	<li class="ext-btn">
		    		<a href="<?php echo app_url($this->data['URL']->controller.'edit/'.$data_id,'url_suffix'); ?>" class="btn btn-default btn-icon">
